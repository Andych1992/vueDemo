	...
	<view>
		...
		<view class="login-form">
			<form @submit="formSubmit">
				<view class="form-input"><input type="text" value="" placeholder="用户名" /></view>
				<view class="form-input"><input type="password" value="" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" /></view>
				<button type="primary" form-type="submit">登录</button>
				<button type="primary" open-type="getUserInfo" @getuserinfo="handleGetUserInfo" @error="handleGetUserInfoError">微信登录</button>
...
export default {
	...
	methods: {
		...
		handleGetUserInfo(getUserInfoRes) {

<template>
	<view class="addMaterial">
		...
		<view class="part">
			<view>物资名称</view>
			<view><input type="text" value="" placeholder="请输入物资名称"/></view>
		</view>
		<view class="part">
			<view>物资类别</view>
		...
		<view class="part">
			<view>计量单位</view>
			<view><input type="text" value="" placeholder="请输入计量单位"/></view>
		</view>
		<view class="part">
			<view>物料规格</view>
			<view><input type="text" value="" placeholder="请输入物料规格"/></view>
		</view>
		<view class="part">
			<view>生产厂家</view>
			<view><input type="text" value="" placeholder="请输入生产厂家"/></view>
		</view>
		<view class="part">
			<view>物资条码</view>
			<view><input type="text" value="" style="width: 400rpx;padding-right: 40rpx;" placeholder="请输入物资条码(不填默认生成)"/><image src="../../static/tabbar/indexpage.png" mode="" class="picturetree"></view>
		</view>
		<view class="part">
			<view>物资排序</view>
			<view><input type="text" value="" placeholder="请输入序号"/></view>
		</view>
		<view class="footer">
			<view class="footerIn">
				<button type="default">返回</button>
				<button type="default">确认新增</button>
			</view>
		</view>
	</view>
</template>

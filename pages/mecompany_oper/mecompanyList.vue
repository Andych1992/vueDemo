	...
	<view>
		...
		<uni-list>
			<block v-for="(item,index) in companyList" :key='index'>
				<uni-list-item :show-arrow="true" :title="(item._ids?(item._ids +'-'):'')+ item.compname" thumb="https://img-cdn-qiniu.dcloud.net.cn/new-page/uni.png"
